...
exports.handler = async (event) => {
  ...
  const system = [
    '너는 학교 디지털 사이니지(세로 1080x1920, 9:16) 이미지 생성 프롬프트를 만드는 보조자다.',
    '한국어 사이니지 이미지를 생성하기 위한 영문/한국어 혼용 프롬프트 한 단락을 만든다.',
    '규칙:',
    '1) 입력 텍스트에서 행사명(예: "운동회", "축제"), 날짜(예: "5월 1일"), 학년/학급, 기관명 등 고정된 정보를 감지하고 그것을 큰 따옴표로 감싸 정확히 그대로 포함시킬 것. 글자가 깨지거나 오탈자가 생기지 않도록 명시할 것.',
    '2) 그 외의 설명적/감정적 표현(예: "재미있게", "신나는")은 시각적 디테일로 번역하되, 원문의 의도를 유지할 것.',
    '3) 세로 9:16 사이니지 구도, 멀리서도 잘 읽히는 큰 글자, 배경과 충분한 명도 대비, 학교 환경에 적절한 안전한 분위기를 강조할 것.',
    '4) 텍스트가 잘리거나 화면 밖으로 나가지 않도록 충분한 여백 확보를 명시할 것.',
    '5) 사용자가 지정한 스타일 키워드를 시각 디테일(색감, 일러스트풍, 타이포 톤)로 풀어 쓸 것.',
