...
- **모서리**: `border-radius: 12px;` (Squircle)
- **정렬**: `display: flex; align-items: center; justify-content: center;`
- **아이콘선 두께**: Lucide SVG 기준 `stroke-width: 2.2;`

### 카테고리/서브카테고리별 컬러 맵
| 서브카테고리 | 배경색 (Light 모드) | 배경색 (Dark 모드) | 아이콘 선 색상 (Light) | 아이콘 선 색상 (Dark) |
| --- | --- | --- | --- | --- |
| 시뮬레이션 (`sub-edu-sim`) | `rgba(0, 111, 238, 0.08)` | `rgba(0, 111, 238, 0.15)` | `#006fee` | `#338ef7` |
| 학습지원 (`sub-edu-learn`) | `rgba(23, 201, 100, 0.08)` | `rgba(23, 201, 100, 0.15)` | `#17c964` | `#4ade80` |
| 업무경감 (`sub-edu-work`) | `rgba(120, 40, 200, 0.08)` | `rgba(120, 40, 200, 0.15)` | `#7828c8` | `#c084fc` |
| 생활편의 (`sub-util-life`) | `rgba(245, 165, 36, 0.08)` | `rgba(245, 165, 36, 0.15)` | `#f5a524` | `#fbbf24` |
| 크롬확장 (`sub-util-chrome`) | `rgba(243, 18, 96, 0.08)` | `rgba(243, 18, 96, 0.15)` | `#f31260` | `#f43f5e` |
| 소셜 (`sub-util-social`) | `rgba(255, 78, 120, 0.08)` | `rgba(255, 78, 120, 0.15)` | `#ff4e78` | `#f43f5e` |
| 크리에이티브 (`sub-util-creative`) | `rgba(0, 183, 222, 0.08)` | `rgba(0, 183, 222, 0.15)` | `#00b7de` | `#38bdf8` |
| 노션도구 (`sub-util-notion`) | `rgba(100, 116, 139, 0.08)` | `rgba(100, 116, 139, 0.15)` | `#64748b` | `#94a3b8` |
| 기본 / 미지정 | `rgba(127, 140, 141, 0.08)` | `rgba(127, 140, 141, 0.15)` | `#7f8c8d` | `#94a3b8` |

### 호버 인터랙션
마우스 호버 시 아이콘 컨테이너가 `scale(1.08)` 커지며, 해당 카테고리 색상값에 맞는 부드러운 네온 광선(`box-shadow: 0 4px 12px rgba(color, 0.2)`)을 연출해야 합니다.
