...
| **세계 탐험대** | `/apps/world-landmarks/` | 3D 지도로 랜드마크 11곳 탐험 + 27개국 국기·수도·음식·문화 조사 보고서 만들기 |
...
| **받아쓰기 도우미** | `/apps/dictation/` | 받아쓰기 급수표 생성·인쇄, 발음 표기 불러주기, 음운규칙별 오류 분석 |
| **어린이 쉬운 사전** | `https://dic.dgedu.link` | 국립국어원 기초사전 기반 초등 눈높이 낱말 풀이 및 사전 (모달) |
